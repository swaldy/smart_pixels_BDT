...
plt.ylim(0,1)
plt.savefig("/eos/user/s/swaldych/smart_pix/labels/models/BDT_class_acceptance_HLS4ML.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.legend()
plt.grid()
plt.savefig("/eos/user/s/swaldych/smart_pix/labels/models/BDT_roc_curve_hls4ML.png", dpi=300, bbox_inches="tight")  #  Save as PNG
