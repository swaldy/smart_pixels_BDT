...
dataset_savedir = f'/eos/user/s/swaldych/smart_pix/dataset_3s_{noise_threshold}NoiseThresh_testing_quantized'
...
test.to_csv(dataset_savedir+'/QuantizedPrecisionInputTestSet_'+sensor_geom+'_0P'+str(threshold - int(threshold))[2:]+'thresh.csv', index=False)
