...
dfX = pd.read_csv(f"/eos/user/s/swaldych/smart_pix/labels/preprocess/QuantizedInputTrainSet_{tag}.csv") #y-local
dfy = pd.read_csv(f"/eos/user/s/swaldych/smart_pix/labels/preprocess/QuantizedTrainSetLabel_{tag}.csv") 
pt=pd.read_csv(f"/eos/user/s/swaldych/smart_pix/labels/preprocess/QuantizedTrainSetPt_{tag}.csv")
